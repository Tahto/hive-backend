...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sys_users_managers_n4', function (Blueprint $table) {
            ...
            $table->index('status');
            // $table->foreign('manager_n5_id')->references('id')->on('sys_users_managers_n5');
        });
    }
    ...
    {
        Schema::dropIfExists('sys_users_managers_n4');
    }
};
