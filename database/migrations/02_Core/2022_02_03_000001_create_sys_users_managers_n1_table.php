...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sys_users_managers_n1', function (Blueprint $table) {
            ...
            $table->index('status');
            // $table->foreign('manager_n2_id')->references('id')->on('sys_users_managers_n2');
        });
    }
    ...
    {
        Schema::dropIfExists('sys_users_managers_n1');
    }
};
