...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('oracle-olap')->create('phone_calls_by_skills_rt', function (Blueprint $table) {
            $table->string("skill");
    ...
    {
        Schema::connection('oracle-olap')->dropIfExists('phone_calls_by_skills_rt');
    }
};
