...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('oracle-olap')->create('phone_calls_by_sectors_n1', function (Blueprint $table) {
    ...
    {
        Schema::connection('oracle-olap')->dropIfExists('phone_calls_by_sectors_n1');
    }
};
