...
class CapacityChargeManagerN4Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $managerN4 =  array_values($managers->unique(function ($item) {
        ...
        CapacityManagerN4::where('ref', $capacityCharge['ref'])->delete();
