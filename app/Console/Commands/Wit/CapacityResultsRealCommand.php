...
class CapacityResultsRealCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'capacity:real';
    ...
    public function handle()
    {
        ...
        foreach ($lines as $key => $value) {
            ...
            $managers =  CapacityManagerSector::where('ref', $ref)
                ->where('sector_id', $value->sector_n1_id)
                ->get([
                    'manager_n5_id',
                    'manager_n4_id',
                    'manager_n3_id'
            ...
            if (!empty($managers)) {
                ...
                $temp['manager_n5_id'] = $managers['manager_n5_id'];
                $temp['manager_n4_id'] = $managers['manager_n4_id'];
                $temp['manager_n3_id'] = $managers['manager_n3_id'];
                $temp['ref'] =  $ref;
                $temp['date'] =  $date;
        ...
        $indicatorId = 11; // HC Treino Inicial -  nu_tr_ini_real
        ...
        $indicatorId = 12; // HC Treino MIG -  nu_tr_mig_real
